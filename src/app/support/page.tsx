  ...
  return (
    <>
      ...
      <main className="legal container">
        ...
        <p>SlowRead offers a free tier with daily reading access, plus 5 free AI cards per day and bilingual mode for the first 3 pages of each book. SlowRead Pro unlocks the full AI reading companion, unlimited bilingual reading, Streak Freeze, and more.</p>
      </main>
