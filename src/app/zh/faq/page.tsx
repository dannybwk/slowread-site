...
const faqs = [
  ...
  {
    q: 'SlowRead 是免費的嗎？',
    a: '是的！SlowRead 完全免費下載使用。免費版包含完整公版書庫、閱讀連續紀錄、個人化排程、每日提醒、月度閱讀回顧，以及 AI 伴讀（每日 5 張）與雙語（前 3 頁）的免費體驗。Pro 進階版（每月 $3.99）解鎖無限 AI 伴讀、完整雙語對照、離線閱讀、連續凍結與年度閱讀報告。',
  },
  {
    q: 'SlowRead 有哪些書？',
  ...
  {
    q: 'AI 伴讀助手怎麼運作？',
    a: 'AI 伴讀（Pro 功能）解決讀經典最常放棄的兩大原因：「忘記前面演什麼了」和「看不懂這裡在說什麼」。每段閱讀後，它會提供前情提要讓你不遺失劇情、隨閱讀進度更新的人物關係圖、文化背景與文學典故解析。免費用戶每天可體驗 5 張 AI 卡片。支援繁中、英文、日文、法文回應。',
  },
  {
    q: 'SlowRead 支援多語言嗎？',
  ...
  {
    q: '一天可以讀超過一段嗎？',
    a: '可以，隨時。「每天一段」是 SlowRead 建議的節奏——慢到能好好吸收經典，又能持續到讀完 700 段的大部頭書。但如果你當天讀得很順想繼續，沒人會擋。免費版和 Pro 都一樣。排程會自動根據實際進度調整。',
  },
  {
    q: 'SlowRead 有廣告嗎？',
