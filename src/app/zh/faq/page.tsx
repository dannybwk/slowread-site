...
const faqs = [
  ...
  {
    q: 'AI 伴讀助手怎麼運作？',
    a: 'AI 伴讀（Pro 功能）解決讀經典最常放棄的兩大原因：「忘記前面演什麼了」和「看不懂這裡在說什麼」。每段閱讀後，它會提供前情提要讓你不遺失劇情、隨閱讀進度更新的人物關係圖、文化背景與文學典故解析、以及深度詞彙注釋。支援繁中、英文、日文、法文回應。',
  },
  {
    q: 'SlowRead 支援多語言嗎？',
    a: '支援！SlowRead 提供雙語並排閱讀功能，可以用原文搭配翻譯閱讀經典。三種模式任選：雙語對照、僅原文、僅翻譯。支援全球主要語系。無論你是文學愛好者還是語言學習者，都能找到最適合的閱讀方式。',
  },
  {
    q: '一本書要讀多久？',
    a: '取決於你的閱讀節奏。例如《紅樓夢》全書 731,000 字，以每天 2,800 字（約 7 分鐘）的速度，大約 262 天可以讀完。SlowRead 會為每本書計算個人化排程，並根據你的實際閱讀進度自動調整完讀日期。',
  },
  {
    q: '中斷一天會怎樣？',
    a: '完全沒有懲罰！你的閱讀排程會自動重新計算。書會等你。SlowRead 的設計理念是透過正向動力鼓勵持續閱讀，而不是製造壓力或罪惡感。',
  },
  {
    q: '段落是怎麼切分的？',
