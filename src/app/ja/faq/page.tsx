...
const faqs = [
  ...
  },
  {
    ...
    a: 'AI読書パートナー（Pro機能）は、古典文学で挫折する二大理由「前の話を忘れた」「背景がわからない」を解決します。各節の後に、あらすじの振り返りで前の話を忘れないようにし、読み進めるごとに更新される人物関係図、文化的背景と文学的典故の解説を提供します。無料ユーザーは毎日2枚のAIカードをお試しいただけます。日本語、英語、中国語、フランス語に対応。',
  },
  {
