...
const faqs = [
  ...
  {
    q: 'SlowReadは無料ですか？',
    a: 'はい！SlowReadは完全無料でダウンロード・利用できます。無料プランには毎日一節の読書、パブリックドメイン全書庫、読書ストリーク、パーソナライズされたスケジュール、毎日のリマインダーが含まれます。Proプラン（月額$3.99）では無制限読書、AI読書パートナー、バイリンガル対訳、オフライン閲覧などが利用できます。',
  },
  {
    q: 'どんな本がありますか？',
  ...
  },
  {
    ...
    a: 'AI読書パートナー（Pro機能）は、古典文学で挫折する二大理由「前の話を忘れた」「背景がわからない」を解決します。各節の後に、あらすじの振り返りで前の話を忘れないようにし、読み進めるごとに更新される人物関係図、文化的背景と文学的典故の解説、深い語彙注釈を提供します。日本語、英語、中国語、フランス語に対応。',
  },
  {
    q: 'SlowReadは多言語に対応していますか？',
    a: 'はい！SlowReadはバイリンガル並列読書に対応しており、原文と翻訳を並べて古典を読めます。3つのモード：バイリンガル、原文のみ、翻訳のみ。世界の主要言語に対応。文学愛好家にも語学学習者にも最適な読書体験を提供します。',
  },
  {
    q: '一冊読み終えるのにどのくらいかかりますか？',
    a: 'あなたのペース次第です。例えば「紅楼夢」（731,000字）は、1日2,800字（約7分）のペースで約262日かかります。SlowReadがすべての本にパーソナライズされたスケジュールを計算し、実際の読書ペースに応じて自動調整します。',
  },
  {
    q: '一日休んだらどうなりますか？',
    a: '何も問題ありません！ペナルティはありません。読書スケジュールは自動で再計算されます。本はあなたを待っています。SlowReadはプレッシャーや罪悪感ではなく、ポジティブなモチベーションで一貫した読書を促すように設計されています。',
  },
  {
    q: 'パッセージはどう分割されますか？',
  ...
  {
    q: '1日に複数の節を読めますか？',
    a: '無料プランでは毎日一節です。Proプランなら無制限に読書できます——読みたいだけ先に進めます。スケジュールは実際の進捗に応じて自動調整されます。',
  },
  {
    q: 'SlowReadに広告はありますか？',
