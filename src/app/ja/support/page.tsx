  ...
  return (
    <>
      ...
      <main className="legal container">
        ...
        <p>SlowRead は、毎日の読書機能に加え、毎日5枚の無料AIカードと各書籍の最初の3ページでのバイリンガル体験を含む無料プランを提供しています。SlowRead Pro にアップグレードすると、フルAI読書パートナー、無制限バイリンガル対訳、ストリークフリーズなど、追加機能をご利用いただけます。</p>
      </main>
